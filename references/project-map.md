...
בנוסף - זה יתברר מריצת הבדיקה הבאה.
   ...
   **⚠️ עדיין לא אומת מול DOM אמיתי של פייסבוק** (אין כלי דפדפן זמין לבדיקה
   חיה בזמן הכתיבה) - מבוסס על תבנית שחוזרת בעקביות בצילומי מסך לאורך
   הפרויקט (שם הכותב מוצג ליד האווטאר בראש הדיאלוג), לא grep על DOM אמיתי.
   **אם זה גורם ל-false positive נוסף - הפעולה הנכונה זהה לפעם הקודמת:
   להחזיר מיד ל-warning-only (לא לנסות "לתקן את הסלקטור" עוד פעם בלי
   ראיה חיה).**
